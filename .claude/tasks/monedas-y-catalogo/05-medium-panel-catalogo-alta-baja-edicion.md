...
- [ ] Validación en cliente del selector espejo de `/^[A-Z][A-Z0-9_-]{0,31}$/` (`docs/openapi.yaml:616`) y del precio como string decimal — el 422 del servidor queda de red; el comentario "no selector is ever typed into this panel" (`MachineDisplay.jsx:58-61`) se actualiza: `invalid_product_selector` pasa a ser alcanzable y con mensaje.
...
- `frontend/src/components/MachineDisplay.jsx:58-61` — alcanzabilidad de `invalid_product_selector`
